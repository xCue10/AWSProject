...
Welcome to PantryPal, a full-stack serverless web application designed to help users elegantly manage their household pantry inventory. This project features a dynamic, responsive frontend with a unique "fancy wedding invitation" aesthetic and a robust backend built on AWS. I created this as a project for an AWS Cloud Bootcamp project. 

TEMP. LIVE DEMO : http://my-pantry-items-jordon.s3-website-us-east-1.amazonaws.com

The main Index.html page showing the form and the "Current Holdings (Recent Items)" sample list.

The all_items.html page displaying items grouped by category, potentially in the two-column layout.

The "Add an Item" form filled out, or the success message after adding an item.

Example Screenshot Placeholder: View Screenshots

Main interface of PantryPal showing the item input form and recent items.


Caption: All pantry items displayed, grouped by category.
...
Advanced Sorting/Filtering: On the "All Items" page, provide options to sort by name, quantity, or filter by category/name.

User Authentication: Implement user accounts (e.g., using AWS Cognito) for personalized pantry lists.
